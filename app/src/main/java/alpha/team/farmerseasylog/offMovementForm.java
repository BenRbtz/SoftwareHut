 ...
 * @author Ben Roberts
 */
public class offMovementForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_off_movement_form);
        ...
        spinner_gender = new ArrayAdapter<String>(offMovementForm.this,
    ...
    private void fieldSetup() {
        sexField.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(offMovementForm.this)
        ...
        calenderField.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                new DatePickerDialog(offMovementForm.this, date, myCalendar
                ...
                if (!(barID.isEmpty() || herdID.isEmpty() || sexID.isEmpty() ||
                    ...
                    new AsyncTask<Void, Void, Boolean>() {
                        ...
                        protected Boolean doInBackground(Void... params) {
                            ...
                            portal.addEntry(herdID, barID, sexID, colourID, birthDate, breedID, false);//sends form to db
                            return true;
                        }
                    }.execute();
                    finish();//closes activity form
                } else {
                    Toast.makeText(offMovementForm.this, "Fill Empty Fields", Toast.LENGTH_SHORT).show();// small pop-up alerting for empty fields
                }
    ...
    private void findViewItems() {
        sendButton = (Button) findViewById(R.id.sendButtonOff);//finds send button
        herdField = (EditText) findViewById(R.id.herdIDOff);//finds herd number field
        barNumField = (EditText) findViewById(R.id.barIDOff);//finds bar number field
        sexField = (EditText) findViewById(R.id.sexIDOff);//finds sex field
        colourField = (EditText) findViewById(R.id.colourIDOff);//finds colour field
        calenderField = (EditText) findViewById(R.id.birthDateOff);//finds birth date field
        breedField = (EditText) findViewById(R.id.breedIDOff);//finds breed field
    }
